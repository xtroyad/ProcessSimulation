...
from multiprocessing import Queue, Process, Array, Barrier, Event
...
if __name__ == '__main__':
    ...
    fourier = Fourier(cola_medidas, cola_datos_fourier, pids, inicio_iu)
    ...
    pids[0] = pid()
    carro = Vehiculo(cola_medidas, cola_medidas_iu, pids, inicio_iu, fin_procesos)
